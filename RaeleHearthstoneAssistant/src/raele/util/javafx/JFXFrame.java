...
public class JFXFrame extends JFrame {
	...
	public JFXFrame(String title, URL fxmlUrl, Callback<JFXFrame, Void> callback)
	throws IOException
	{
		super(title);
	...
	private void setup(Callback<JFXFrame, Void> callback) {
		// Setup JFX
